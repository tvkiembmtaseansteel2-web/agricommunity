...
- [ ] *(Nếu cần)*: domain riêng, OAuth Google/GitHub, tối ưu SEO/meta, thu phí tự động, SMS OTP cho quên mật khẩu, thêm kênh uy tín vào whitelist, tự động backfill embedding khi thêm KB.
