...
- [ ] *(Còn lại — cần bạn thao tác trên dashboard)*: **thêm domain** `https://agricommunity.netlify.app` vào **Allowed Redirect URLs** trong Supabase Auth (để đăng nhập ổn định nhất / OAuth sau này); (nếu cần) cấp lại GitHub PAT có `workflow` scope để bật CI.
